...
--config=/ssd/models/DeepSeek-R1-Distill-Qwen-7B/config.json \
--tokenizer=/ssd/models/DeepSeek-R1-Distill-Qwen-7B/ \
--weight=/ssd/models/DeepSeek-R1-Distill-Qwen-7B_converted \
--model_type=qwen2 \
--device_type=npu \
--max_seq_len=8192 \
--max_gen_token=8192 \
