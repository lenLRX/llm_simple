...
--config=/ssd/models/Qwen2.5-14B-Instruct-AWQ/config.json \
--tokenizer=/ssd/models/Qwen2.5-14B-Instruct-AWQ/ \
--weight=/ssd/models/Qwen2.5-14B-Instruct-AWQ_converted \
--model_type=qwen2 \
--device_type=npu \
--max_seq_len=8192 \
--max_gen_token=256 \
